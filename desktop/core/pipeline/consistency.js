...
屏幕上显示什么、纸上写着什么、盒子里装着什么、灯亮没亮 ——
这些都是**剧情**，会一镜一镜地变，不是这件道具的样子。

写进去的代价很具体：道具描述会注入到出现这件道具的**每一镜**，
参考图也是照着它出的。手机的描述里写了"屏幕上是一张红色标记的地图"，
那么他把手机贴在耳朵上打电话的那一镜，手机背面也会印着那张地图。
...

{
  ...
  "props": [
    {
      "name": "道具名",
      "appearance": "这个东西本身长什么样（30字内）：形状、材质、颜色、大小、标志性细节",
