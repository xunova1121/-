...
STAGE_POLICIES = {
    "quality": {"parallelism": 2, "consistency_threshold": 88, "transition_engine": "tail_frame_dependency", "max_retries": 3},
...
def automation_plan(episode: int, mode: str, shot_count: int, blockers: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    stages = [
        ...
        {"id": "seams", "action": "generate_continuous_shots_from_real_tail_frames", "depends_on": ["videos"], "items": max(0, shot_count - 1)},
